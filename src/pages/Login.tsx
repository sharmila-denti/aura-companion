    ...
    <div className="min-h-screen gradient-soft flex flex-col items-center justify-center px-8 text-center">
      ...
      >
        <button
          ...
          className="w-full h-14 rounded-2xl bg-white border border-border shadow-sm flex items-center justify-center gap-3 font-semibold text-foreground hover:shadow-md transition-shadow"
        >
